...
function ImageUpload() {
  ...
  const handleUpload = async (e) => {
    ...
    if (img !== defaultImg) {
      await axios
        .post("https://d3crypt-2023-backend.onrender.com/delete-image/" + key)
        .then((res) => {
          ConsoleHelper(res);
        })
        .catch((error) => {
    ...
    axios
      .post("https://d3crypt-2023-backend.onrender.com/image", imageInput)
      .then(
        (response) => {
          ...
          axios
            .post("https://d3crypt-2023-backend.onrender.com/user-img", data, {
              headers: {
                "x-access-token": jwt,
              },
            })
  ...
  useEffect(async () => {
    ...
    if (token) {
      ...
      await axios
        .post(
          "https://d3crypt-2023-backend.onrender.com/get-user",
          {},
          {
            headers: {
              "x-access-token": jwt,
        ...
        .then(
          (response) => {
            ...
            if (response.data.imgKey) {
              ...
              setImg(
                "https://d3crypt-2023-backend.onrender.com/image/" +
