...
export default function MobileNavbar() {
  ...
  useEffect(async() => {
    ...
    await axios
      .get("https://d3crypt-2023-backend.onrender.com/user", {
        headers: {
  ...
  useEffect(async () => {
    ...
    axios.get("https://d3crypt-2023-backend.onrender.com/users/:idy", { params: { id: jwt } })
    .then((res) => {
      console.log(res.data.imgKey);
      if (res && res.data.imgKey) {
        var x = "https://d3crypt-2023-backend.onrender.com/image/" + res.data.imgKey;
        setImgsrc(x)
      }
    });
},[]);
