...
function Ranks({ remainingList, first, second, third }) {
  if (first && first.imgKey) {
    var firstImgSrc = "https://d3crypt-2023-backend.onrender.com/image/" + first.imgKey;
  }
  else {
  ...
  if (second && second.imgKey) {
    var secondImgSrc = "https://d3crypt-2023-backend.onrender.com/image/" + second.imgKey;
  }
  else {
  ...
  if (third && third.imgKey) {
    var thirdImgSrc = "https://d3crypt-2023-backend.onrender.com/image/" + third.imgKey;
  }
  else {
